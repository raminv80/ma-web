...
$config['backends'][] = array(
    ...
    'adapter'      => 'local',
    'baseUrl'      => '/',
    'root'         => $_SERVER['DOCUMENT_ROOT'], // Can be used to explicitly set the CKFinder user
    // files directory.
    'chmodFiles'   => 0775,
    'chmodFolders' => 0775,
...
$config['resourceTypes'][] = array(
    ...
    'directory'         => 'uploads',
    'maxSize'           => 0,
    'allowedExtensions' => 'csv,doc,docx,pdf,ppt,pptx,rtf,txt,gif,jpeg,jpg,png,gz,gzip,mp4,mpeg,mpg,tar,tgz,zip',
    'deniedExtensions'  => '',
    'backend'           => 'default'
);
