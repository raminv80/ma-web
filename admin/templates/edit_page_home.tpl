      ...
      <div class="tab-content">
        ...
        <div class="tab-pane active" id="details">
          <div class="form" data-error="Error found on <b>Details tab</b>. View <b>Details tab</b> to see specific error notices.">
            ...
            <div class="row form-group">
              <label class="col-sm-3 control-label" for="id_listing_content2">Bottom content headline</label>
              <div class="col-sm-5">
                <textarea name="field[1][tbl_listing][{$cnt}][listing_content2]" id="id_listing_content2" class="form-control">{$fields.listing_content2}</textarea>
              </div>
            </div>
            <!-- <div class="row form-group">
