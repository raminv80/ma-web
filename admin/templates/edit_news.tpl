		...
		<form class="well form-horizontal" id="Edit_Record" accept-charset="UTF-8" action="/admin/includes/processes/processes-record.php" method="post">
			<div class="row-fluid">
				<div class="span12">
					...
					<input type="hidden" value="{$parentID}" name="field[1][tbl_listing][{$cnt}][listing_parent_id]" id="id_listing_parent">
				</div>
			</div>
			...
			<div class="span9 controls">
				<input type="hidden" value="news_id" name="field[1][tbl_news][{$cnt}][id]" />
				<input type="hidden" value="listing_id" name="default[news_listing_id]" />
				<input type="hidden" value="{$fields.news_id}" name="field[1][tbl_news][{$cnt}][news_id]" >
				<input type="hidden" value="{$fields.listing_id}" name="field[1][tbl_news][{$cnt}][news_listing_id]" />
				<input type="text" value="{$fields.news_start_date}" name="field[1][tbl_news][{$cnt}][news_start_date]" id="news_start_date" class="req" >
