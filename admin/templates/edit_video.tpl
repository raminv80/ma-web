			...
			<div class="tab-content">
              ...
              <div class="col-sm-2">
                ...
                <a href="javascript:void(0);" class="btn btn-info btn-sm marg-5r edit-url" onclick="$('.edit-url').removeClass('url-text').hide();$('#id_listing_url').get(0).type='text';">Edit URL</a> 
						...
						<div class="row form-group">
							<label class="col-sm-3 control-label" for="id_listing_content1">Video IFrame Content</label>
							<div class="col-sm-5">
						...
						<div class="row form-group">
              <label class="col-sm-3 control-label" for="id_listing_content2">Text Content</label>
              <div class="col-sm-5">
