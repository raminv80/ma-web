          ...
          <div class="form" data-error="Error found on <b>Details tab</b>. View <b>Details tab</b> to see specific error notices.">
            ...
            <div class="row form-group">
              <label class="col-sm-3 control-label" for="listing_image">
                 Image<br><small>Size: 800px Wide x 800px Tall</small>
              </label>
              <div class="col-sm-9">
            ...
            <div class="row form-group">
              <label class="col-sm-3 control-label" for="id_listing_content1">Location and date</label>
              <div class="col-sm-5">
            ...
            <div class="row form-group">
              <label class="col-sm-3 control-label" for="id_listing_content2">Story</label>
              <div class="col-sm-5">
                <textarea name="field[1][tbl_listing][{$cnt}][listing_content2]" id="id_listing_content2" rows="11" class="form-control">{$fields.listing_content2}</textarea>
              </div>
            </div>
            <div class="row form-group">
              <label class="col-sm-3 control-label" for="id_listing_content3">Additional content</label>
              <div class="col-sm-5">
