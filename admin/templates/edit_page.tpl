...
<div class="row-fluid">
	...
	<form class="well form-horizontal" id="Edit_Record" accept-charset="UTF-8" action="/admin/includes/processes/processes-record.php" method="post">
		...
		<!--  <div class="row-fluid control-group">
		 ...
		 <div class="row-fluid control-group">
			<div class="span3"><label class="control-label" for="listing_image">Page Link Icon</label><br/><label class="control-label small-txt" >Size: 580px Wide x 260px Tall</label></div>
			<div class="span9 controls">
		...
		{if $fields.listing_id neq ""}
		 <div class="row-fluid control-group">
			<div class="span3"><label class="control-label" for="gallery_image_{$count}">Header Images</label><br/><label class="control-label small-txt" >Size:<br>(First) 550px Wide x 250px Tall<br>(Others) 250px Wide x 250px Tall</label><br/><label class="control-label small-txt" >Max 3 images</label></div>
			<div class="span9 controls" id="gallery">
				...
				<div class="row-fluid gallery_item" rel="{$count}">
					<div class="span4" id="gallery_{$count}">
						...
						<input type="hidden" value="{$item.gallery_listing_id}" name="field[1][tbl_gallery][{$count}][gallery_listing_id]" class="fileinput">
