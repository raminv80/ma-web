          ...
          <div class="form" data-error="Error found on <b>Details tab</b>. View <b>Details tab</b> to see specific error notices.">
            ...
            <div class="row form-group">
              <label class="col-sm-3 control-label" for="listing_image">
                Hero Image<!--<br> <small>Size: 1960px Wide x 345px Tall <br>("None" for default image)-->
                </small>
              </label>
              <div class="col-sm-9">
            ...
            <div class="row form-group">
              ...
              <div class="col-sm-5">
                <textarea rows="4" maxlength="200" name="field[1][tbl_listing][{$cnt}][listing_content1]" id="id_listing_content1" class=form-control>{$fields.listing_content1}</textarea>
              </div>
            </div>
            <div class="row form-group">
