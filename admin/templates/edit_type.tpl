	...
	<form class="well form-horizontal" id="Edit_Record" accept-charset="UTF-8" action="/admin/includes/processes/processes-record.php" method="post">
		<div class="row-fluid">
			<div class="span12">
				...
				<input type="hidden" value="{$fields.type_id}" name="field[tbl_type][{$cnt}][type_id]" id="type_id" />
				<input type="hidden" value="type_id" name="field[tbl_type][{$cnt}][id]" id="id" />
			</div>
		</div>
		<div class="row-fluid control-group">
            <div class="span3"><label class="control-label" for="type_name">Name</label></div>
            <div class="span9 controls"><input type="text" value="{$fields.type_name}" name="field[tbl_type][{$cnt}][type_name]" id="type_name" class="req"></div>
		</div>
		<div class="row-fluid">
