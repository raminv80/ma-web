	...
	<form class="well form-horizontal" id="Edit_Record" accept-charset="UTF-8" action="/admin/includes/processes/processes-record.php" method="post">
		...
		<div class="row-fluid control-group">
			...
			<div class="span9">
				...
				<input type="hidden" value="{$fields.listing_content4}" name="field[1][tbl_listing][{$cnt}][listing_content4]" id="location_latitude">
				<input type="hidden" value="{$fields.listing_content5}" name="field[1][tbl_listing][{$cnt}][listing_content5]" id="location_longitude">
