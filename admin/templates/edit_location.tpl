	...
	<form class="well form-horizontal" id="Edit_Record" accept-charset="UTF-8" action="/admin/includes/processes/processes-record.php" method="post">
		<div class="row-fluid">
			<div class="span12">
				...
				<input type="hidden" value="3" name="field[1][tbl_listing][{$cnt}][listing_type_id]" id="listing_type_id">
			</div>
		</div>
		...
		<div class="row-fluid control-group">
			...
			<div class="span9 controls">
			<input type="hidden" value="{$fields.listing_flag1}" name="field[1][tbl_listing][{$cnt}][listing_flag1]" class="value">
		...
		<div class="row-fluid control-group">
			...
			<div class="span9">
				...
				<input type="hidden" value="{$fields.location_id}" name="field[1][tbl_location][{$cnt}][location_id]" >
				<input type="hidden" value="{$fields.listing_id}" name="field[1][tbl_location][{$cnt}][location_listing_id]" id="location_listing_id" />
