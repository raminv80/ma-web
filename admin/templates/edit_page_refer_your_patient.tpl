      ...
      <div class="tab-content">
        ...
        <div class="tab-pane active" id="details">
          <div class="form" data-error="Error found on <b>Details tab</b>. View <b>Details tab</b> to see specific error notices.">
            ...
            <div class="row form-group">
              <label class="col-sm-3 control-label" for="id_listing_associate4">Associated news category</label>
              <div class="col-sm-5">
                <select class="form-control" name="field[1][tbl_listing][{$cnt}][listing_associate4]" id="id_listing_associate4">
                  <option value="NULL">None</option>
                  {call name=options_list opts=$fields.options.news_categories selected=$fields.listing_associate4}
                </select>
              </div>
            </div>
          </div>
