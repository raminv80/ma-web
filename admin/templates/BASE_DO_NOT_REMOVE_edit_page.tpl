...
<div class="row-fluid">
	...
	<form class="well form-horizontal" id="Edit_Record" accept-charset="UTF-8" action="/admin/includes/processes/processes-record.php" method="post">
		...
		<div class="row-fluid control-group">
			...
			<div class="span9 controls">
			<input type="hidden" value="{$fields.listing_flag2}" name="field[1][tbl_listing][{$cnt}][listing_flag2]" class="value">
		...
		<div class="row-fluid control-group">
			...
			<div class="span9 controls">
			<input type="hidden" value="{$fields.listing_flag3}" name="field[1][tbl_listing][{$cnt}][listing_flag3]" class="value">
