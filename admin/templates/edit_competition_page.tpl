...
<div class="row">
  <div class="col-sm-12">
  <form id="Get_Competition_Entries" accept-charset="UTF-8" method="post" action='/admin/includes/processes/get-competition-entries-csv.php'>
    <input type="hidden" value="{$fields.listing_object_id}" name="competition_reference_id">
  </form>
    ...
    <form class="well form-horizontal" id="Edit_Record" accept-charset="UTF-8" method="post">
      <div class="row">
        ...
        <a href="javascript:void(0);" id="Get_Entries" class="btn btn-primary pull-left top-btn"><span class="glyphicon glyphicon-cloud-download"></span> Get Entries</a>
      ...
      <div class="tab-content">
        ...
        <div class="tab-pane active" id="details">
          <div class="form" data-error="Error found on <b>Details tab</b>. View <b>Details tab</b> to see specific error notices.">
            ...
            <div class="row form-group">
              <label class="col-sm-3 control-label" for="listing_file">
                Terms &amp; Conditions
              </label>
              <div class="col-sm-9">
                <input type="hidden" value="{$fields.listing_file}" name="field[1][tbl_listing][{$cnt}][listing_image2]" id="listing_file_link" class="fileinput">
                <span class="file-view" id="listing_file_path"> {if $fields.listing_image}<a href="{$fields.listing_image2}" target="_blank">View</a>{else}None{/if}
                </span> <a href="javascript:void(0);" class="btn btn-info marg-5r" onclick="getFileType('listing_file','','');">Select File</a> <a href="javascript:void(0);" class="btn btn-info" onclick="$('#listing_file_link').val('');$('#listing_file_path').html('None');">Remove File</a>
              </div>
            </div>            
            <div class="row form-group">
...
//     $.ajax({
//       type: "POST",
//       url: "/admin/includes/processes/get-competition-entries-csv.php",
//       cache: false,
//       data: "competition_reference_id=" + $('#listing_object_id').val(),
//       dataType: "html",
//       success: function(data, textStatus) {
//         try{
//           console.log(data);
...
//   }
  ...
  $('#Get_Entries').click(function() {
    $('#Get_Competition_Entries').submit();
  })
