      ...
      <div class="tab-content">
        ...
        <div class="tab-pane active" id="details">
          <div class="form" data-error="Error found on <b>Details tab</b>. View <b>Details tab</b> to see specific error notices.">
            ...
            <div class="row form-group">
              <label class="col-sm-3 control-label" for="id_listing_content2">Forbidden message</label>
              <div class="col-sm-5">
            ...
            <div class="row form-group">
              <label class="col-sm-3 control-label" for="id_listing_content3">Special compaign message</label>
              <div class="col-sm-5">
