		...
		<form class="well form-horizontal" id="Edit_Record" accept-charset="UTF-8" action="/admin/includes/processes/processes-record.php" method="post">
			...
			<div class="row-fluid control-group">
				<div class="span3">
					...
					<label class="control-label small-txt">Size: 1960px Wide x 420px Tall <br>("None" for default image)</label>
				</div>
				<div class="span9 controls">
			...
			<div class="row-fluid control-group">
				<div class="span3">
					<label class="control-label" for="listing_content4">Bottom Ad-Banner</label><br />
					<label class="control-label small-txt">Size: 780px Wide x 90px Tall</label>
				</div>
				<div class="span9 controls">
					<input type="hidden" value="{$fields.listing_content4}" name="field[1][tbl_listing][{$cnt}][listing_content4]" id="listing_content4_link" class="fileinput"> <span class="file-view" id="listing_content4_view" {if $fields.listing_content4 eq ""}style="display: none"{/if} > <a
						href="{$fields.listing_content4}" target="_blank" id="listing_content4_path">{$fields.listing_content4}</a>
					</span> <span class="file-view" id="listing_content4_none" {if $fields.listing_content4 neq ""}style="display: none"{/if}>None</span> <a href="javascript:void(0);" class="btn btn-info marg-5r"
						onclick="
					getFileType('listing_content4','','');
					$('#listing_content4_view').css('display','block');
					$('#listing_content4_none').css('display','none');
					">Select File</a> <a href="javascript:void(0);" class="btn btn-info"
						onclick="
				$('#listing_content4').val('');
				$('#listing_content4_view').css('display','none');
				$('#listing_content4_none').css('display','block');
				">Remove File</a>
				</div>
			</div>
			<div class="row-fluid control-group">
				<div class="span3">
					<label class="control-label" for="id_listing_content5">Ad-Banners Link</label>
				</div>
				<div class="span9 controls">
