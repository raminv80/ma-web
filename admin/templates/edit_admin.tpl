...
<div class="row-fluid">
	...
	<form class="well form-horizontal" id="Edit_Record" accept-charset="UTF-8" action="/admin/includes/processes/processes-record.php" method="post">
		...
		<div class="row-fluid control-group">
			...
			<div class="span9 controls"><input type="text" value="{$fields.admin_email}" id="admin_reemail" class="req email"></div>
		</div>
		<div class="row-fluid control-group">
			<div class="span3"><label class="control-label" for="password">Password</label></div>
			<div class="span9 controls"><input type="password" value="" id="password"></div>
		</div>
		<div class="row-fluid control-group">
			<div class="span3"><label class="control-label" for="re_password">Retype Password</label></div>
