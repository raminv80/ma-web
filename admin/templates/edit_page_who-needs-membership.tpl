  ...
  <div class="col-sm-12">
    <form class="well form-horizontal" id="Edit_Record" accept-charset="UTF-8" method="post">
      ...
      <ul class="nav nav-tabs" id="myTab">
        ...
        <li><a href="#files" data-toggle="tab">Categories</a></li>
      ...
      <div class="tab-content">
        ...
        <div class="tab-pane" id="files">
          ...
          <div class="row btn-inform">
            <a href="javascript:void(0);" class="btn btn-success btn-add-new" onclick="$('.files').slideUp();newFile();"> Add new category</a>
          </div>
