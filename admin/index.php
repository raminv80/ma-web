...
/* if (!$_SERVER['HTTPS'] || $_SERVER['SERVER_PORT'] != 443){
	$securl= 'https://'.$_SERVER['HTTP_HOST'] .'/'. $_SERVER['REQUEST_URI'];
	header("HTTP/1.1 301 Moved Permanently");
	header("Location: $securl");
	exit();
} */
...
$SMARTY->assign('DOMAIN', (($_SERVER['HTTPS'] || $_SERVER['SERVER_PORT'] == 443)?"https://":"http://") . $GLOBALS['HTTP_HOST']);
