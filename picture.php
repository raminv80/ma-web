...
/*  PROJECT INFO --------------------------------------------------------------------------------------------------------
    Project:   Responsive Picture,
    Version:   0.5
    Customised by Nicholas Spragg to function in conjunction with the Picture Element to provide appropriate images at each break point. 
    
    Based on code from the project Adaptive Images by Matt Wilcox is licensed under a Creative Commons Attribution 3.0 Unported License.
...
/*  FUNCTIONS -----------------------------------------------------------------------------------------------------------
 These are the functions which are used by the application
*/
