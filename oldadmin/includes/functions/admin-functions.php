...
include 'oldadmin/includes/functions/admin-functions-general.php';
include 'oldadmin/includes/classes/misc-class.php';
include 'oldadmin/includes/classes/page-class.php';
include 'oldadmin/includes/classes/form-class.php';
include 'oldadmin/includes/classes/filelink-class.php';
include 'oldadmin/includes/classes/fileupload-class.php';
