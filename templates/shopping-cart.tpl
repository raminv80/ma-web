        ...
        <form class="form-horizontal" id="shopping-cart-form" accept-charset="UTF-8" action="" method="post">
          <div class="row tallbox">
            ...
            <div id="{$item.cartitem_id}" class="prod-item cartitem">
              <div class="col-xs-2 col-sm-1 text-center valgn">
                <a href="javascript:void(0)" onclick="deleteItem('{$item.cartitem_id}');">X</a>
              </div>
          ...
          <div class="col-sm-12">
            <div class="row tallrow" id="disccode">
              ...
              <form class="form-horizontal" id="discount-form" accept-charset="UTF-8" action="/process/cart" method="post">
                ...
                <div class="col-xs-6 col-sm-3 col-md-2 num text-right" id="discount">
                  {if $totals.discount gt 0} <small><b>$-{$totals.discount|number_format:2:".":","}</b></small> {else} $0.00 {/if}
                </div>
              </form>

            </div>
            <div class="row tallrow">
              <div class="col-sm-offset-2 col-md-offset-2 col-sm-5 col-md-5 "></div>
              <div class="col-xs-5 col-sm-2 col-md-3 shopping-label">Subtotal</div>
            ...
            <div class="row tallrow">
              ...
              {foreach $shippingMethods as $k => $v}
                ...
                <div class="col-xs-5 col-sm-2 col-md-3 shopping-label">{$k}</div>
                <div class="col-xs-7 col-sm-3 col-md-2 num text-right">${$v|number_format:2:".":","}</div>
                {break}
              {/foreach}
              </form>
            </div>
            ...
            *}
            ...
            <div class="row tots tallrow"><!-- The following SUBTOTAL value was intentionally changed to TOTAL  -->
              <div class="col-xs-5 col-sm-2 col-sm-offset-7 col-md-offset-7 col-md-3 shopping-label bold">Total</div>
