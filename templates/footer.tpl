	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12 text-center">
				...
				<p>If you, or someone you care for, are one of the many Australians living with a health condition, sign up to our email newsletter and be the first to hear about the latest news and special offers from MedicAlert<sup>&reg;</sup></p>
				<br />
