              ...
              <form class="form-horizontal" id="register-form" data-attr-id="register-form" role="form" accept-charset="UTF-8" action="" method="post">
                ...
                <div class="row">
                  <div class="col-sm-12 form-group">
                    ...
                    <input type="text" value="{if $post}{$post.mobile}{/if}" class="form-control" id="mobile" name="mobile" pattern="[0-9]" required>
                    <div class="error-msg help-block"></div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-sm-12 form-group chkbx">
                    ...
                    <label for="agree" class="chkbox visible-ie-only">
                      I agree to MedicAlert Foundation’s <a href="#">terms and conditions</a>.<span>*</span>
                    </label>
                    <div class="error-msg help-block"></div>
                  </div>
                </div>
