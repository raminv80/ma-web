		...
		<div class="row">
			<div id="popslide" class="flexslider">
			  <ul class="slides">
				...
				<div class="prod">
					<a href="#">
						<img src="/images/pop1.jpg?width=757&height=484&crop=1" alt="Popular product 1" class="img-responsive" />
					</a>
					<div class="prod-labels">
					</div>
					<div class="prod-info">
						<div class="prod-name"><a href="#">
							Stainless steel expanda band
						</a></div>
				...
				<div class="prod">
					<a href="#">
						<img src="/images/pop2.jpg?width=757&height=484&crop=1" alt="Popular product 1" class="img-responsive" />
					</a>
					<div class="prod-labels">
					</div>
					<div class="prod-info">
				...
				<div class="prod">
					<a href="#">
						<img src="/images/pop3.jpg?width=757&height=484&crop=1" alt="Popular product 1" class="img-responsive" />
					</a>
					<div class="prod-labels">
				...
				<div class="prod">
					<a href="#">
						<img src="/images/pop4.jpg?width=757&height=484&crop=1" alt="Popular product 1" class="img-responsive" />
					</a>
					<div class="prod-labels">
						<div class="prod-label btn btn-white">New</div>
					</div>
