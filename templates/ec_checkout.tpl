				...
				<div class="col-sm-12">
		            ...
		            <div class="row tallrow">
		              {foreach $shippingMethods as $k => $v}
		                ...
		                <div class="col-xs-8 col-sm-8 col-md-10 shopping-label text-right  mobl">{$k} <img src="/images/question-mark.png" alt="Please allow approximately 10 working days to receive your order." title="Please allow approximately 10 working days to receive your order." data-toggle="tooltip" data-placement="top" /></div>
