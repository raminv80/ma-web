...
{/if}
			...
			<div class="col-sm-6 col-md-8">
	            ...
	            <div class="row tallrow">
	              ...
	              {foreach $shippingMethods as $k => $v}
	                ...
	                <div class="col-xs-5 col-sm-8 col-md-10 shopping-label text-right  mobl">{$k} <img src="/images/question-mark.png" alt="Please allow up to 10 business days to process and dispatch your order." title="Please allow up to 10 business days to process and dispatch your order." data-toggle="tooltip" data-placement="top" /> </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-6 col-md-3 col-sm-offset-6 col-md-offset-9 text-center">
            <button id="cart-continue-btn"
                    class="btn btn-red process-cnt" type="button" onclick="$('#checkout1-form').submit();">Continue</button>
          </div>
