...
class cart{
  ...
  function CountProductsInCart(){
    ...
    $sql = "SELECT * FROM tbl_cartitem WHERE cartitem_deleted IS NULL AND cartitem_cart_id = :id";
    return count($DBobject->wrappedSql($sql, array(':id' => $this->cart_id)));
  }
  ...
  /**
   * ONLY FOR MAF
   * Remove membership fee service cartitem from the current cart
   *
   * @return boolean
   */
  function RemoveMembershipFeeCartitem(){
    global $DBobject;
