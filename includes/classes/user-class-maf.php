...
class UserClass{
  ...
  /**
  * Process pending renewal payment for member
  *
  * @param array $_memeberPaymentRecord
  * @param string $_email
  * @return boolean
  */
  function processPayment($_memberPaymentRecord){
    ...
    try{
      if($results = $this->medicAlertApi->memberProcessPayment($token, $_memberPaymentRecord)){
        //payment processed
        $this->medicAlertApi->logout($token);
        return $results;
      }
