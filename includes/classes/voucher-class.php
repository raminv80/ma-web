...
class Voucher{
  ...
  function CreateVoucher($_data){
    $params = array(
        ...
        ":voucher_anonymous" => $_data['anonymous'],
    ...
    $sql = "INSERT INTO tbl_voucher (voucher_payment_id, voucher_code, voucher_name, voucher_email, voucher_recipientname, voucher_recipientemail, voucher_message, voucher_anonymous, voucher_amount, voucher_start_date, voucher_end_date, voucher_code_email_id, voucher_confirmation_email_id, voucher_created)
			values (:voucher_payment_id, :voucher_code, :voucher_name, :voucher_email, :voucher_recipientname, :voucher_recipientemail, :voucher_message, :voucher_anonymous, :voucher_amount, :voucher_start_date, :voucher_end_date, :voucher_code_email_id, :voucher_confirmation_email_id, NOW())";
